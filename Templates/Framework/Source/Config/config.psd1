@{
    ...
    MSI = @{
        ...
        SilentParams = 'ALLUSERS=1 ISCHECKFORUPDATES=0 ROOTDRIVE=C:\ ARPNOREMOVE=1 ARPNOMODIFY=1 REBOOT=ReallySuppress /QN'

        # MSI uninstall parameters.
        UninstallParams = 'ALLUSERS=1 ISCHECKFORUPDATES=0 ROOTDRIVE=C:\ ARPNOREMOVE=1 ARPNOMODIFY=1 REBOOT=ReallySuppress /QN'
    }
