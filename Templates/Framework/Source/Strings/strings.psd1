@{
    ...
    CloseAppsPrompt = @{
        ...
        CustomMessage = 'Once defferal has expired, you will no longer have the option to defer. Once you click on close apps & install. Citrix Workspace App along with all the open AVC sessions will be closed & installation will commence.'
    }
}